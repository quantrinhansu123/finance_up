    ...
    const navGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                ...((userPermissions.canCreateIncome || userPermissions.canCreateExpense) ? [{ name: t("income_expense_categories"), href: "/finance/income-expense-categories", icon: <ScrollText size={18} /> }] : []),
